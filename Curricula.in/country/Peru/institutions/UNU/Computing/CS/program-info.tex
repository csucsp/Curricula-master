...
\input{\InProgramDir/Plan2023-Sem2023-I.config}
...
\newcommand{\SchoolURL}{\htmladdnormallink{http://cs.unu.edu.pe}{http://cs.unu.edu.pe}\xspace}
...
{\begin{description}%
\item [Académico degree: ] \AcademicDegreeIssuedEN\xspace y% 
% \item [Professional title: ] \TitleIssuedEN%
\end{description}%
}

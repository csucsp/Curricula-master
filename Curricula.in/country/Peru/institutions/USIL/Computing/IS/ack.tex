\chapter*{Agradecimientos}\label{chap:ack}
...
\begin{itemize}
\item Kattia Suere (USIL) por su tremenda contribucion en la corrección de tosos los errores menores de cada curso.
...
\item Pedro Shiguihara (USIL, Perú) por su contribución en la línea de Inteligencia Artificial 
...
\item Christian Jorge Delgado Polar (IME-USP, Brasil, UCSP Perú)
...
\item Dr. Bruno Schulze (Laboratorio Nacional de Computação Científica, Brasil) por su apoyo en la línea de investigación de aplicación de computación distribuida a la bio-informática.
...
\item Cuerpo docente de la UTEC, UCSP y de la USIL.
\end{itemize}

...
\end{topics}
\begin{learningoutcomes}
	\item Analizar y comprender qué es significa ser ``persona humana'', 
	desde los orígenes de la noción hasta el aporte definitivo del cristianismo; 
	comprender la fundamentación de la dignidad de la persona humana 
	desde una perspectiva metafísica y cristiana; 
	comprender las manifestaciones de la persona humana a través 
	de su naturaleza en un plano dinámico-existencial. [\Usage].
\end{learningoutcomes}
\end{unit}

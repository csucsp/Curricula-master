\begin{BKL2}{IT1}{Arquitectura de Computadores}
Horas:
...
-Unidad de control; \textit{fetch} y ejecución de instrucciones, \textit{fetch} de operadores.
-CISC, RISC.
...
-Periféricos: almacenamiento externo, organización física y \textit{drives}.
...
(begin_subtopics)
-Elementos lógicos y teoría de \textit{switching}; conceptos e implementación de minimización.
...
\begin{BKL2}{IT2}{Algoritmos y Estructuras de Datos}
Horas:
...
-Estrategias de resolución de problemas usando algoritmos de \textit{back- tracking}.
...
-Estrategias de implementación (\textit{top-down}, \textit{bottom-up}; equipo vs. individual).
...
(begin_subtopics)
-Algoritmos de ordenamiento (\textit{shell sort}, \textit{bucket sort}, \textit{radix sort}, \textit{quick sort}), edición.
...
-\textit{Backtracking}, \textit{parsing}, simulaciones discretas, etc.
...
\begin{BKL2}{IT3}{Lenguajes de Programación}
Horas:
...
\begin{BKL2}{IT4}{Sistemas Operativos}
Horas:
...
\begin{BKL2}{IT5}{Telecomunicaciones}
Horas:
...
-Redes de área local y WANs: topología, \textit{gateways}, usos (funciones y oficina).
...
(begin_topics)
-Redes de área amplia: técnicas de \textit{switching}, de \textit{broadcast}, \textit{routing}.
(begin_subtopics)
(end_subtopics)
(begin_goals)
(end_goals)
...
-Redes, \textit{routing}, análisis de desempeño.
...
-Bases de datos distribuidas, repositorios y \textit{warehouses}
(begin_subtopics)
(end_subtopics)
(begin_goals)
(end_goals)
...
\begin{BKL2}{IT7}{Inteligencia Artificial}
Horas:
...
\begin{BKL2}{OMC1}{Teoría General de Organizaciones}
Horas:
...
\begin{BKL2}{OMC2}{Gerenciamiento de Sistemas de Información}
Horas:
...
(begin_topics)
-Control de la función de Sistemas de Información: p.e., auditoría, \textit{outsourcing}.
(begin_subtopics)
(end_subtopics)
(begin_goals)
(end_goals)
...
(begin_topics)
-Estructuras funcionales de Sistemas de Información -- internas vs. \textit{outsourcing}.
(begin_subtopics)
(end_subtopics)
(begin_goals)
(end_goals)
...
(begin_topics)
-Sistemas de Información como una función de servicio: evaluación del desempeño -- externo e interno, \textit{marketing} de servicios.
(begin_subtopics)
(end_subtopics)
(begin_goals)
(end_goals)
...
-Administración de las relaciones de consultoría, \textit{outsourcing}.
...
(begin_topics)
-Administración de operaciones del computador: p.e. administración de cinta/DASD, \textit{scheduling}.
(begin_subtopics)
(end_subtopics)
(begin_goals)
(end_goals)
...
\begin{BKL2}{OMC3}{Teoría de Decisiones}
Horas:
...
\begin{BKL2}{OMC4}{Comportamiento Organizacional}
Horas:
...
\begin{BKL2}{OMC7}{Manejo del Proceso de Cambio}
Horas:
...
\begin{BKL2}{OMC8}{Aspectos Legales y Éticos de los Sistemas de Información}
Horas:
...
\begin{BKL2}{OMC9}{Profesionalismo}
Horas:
...
\begin{BKL2}{OMC10}{Habilidades Interpersonales}
Horas:
...
\begin{BKL2}{TDS1}{Conceptos de Información y de Sistemas}
Horas:
...
\begin{BKL2}{TDS2}{Metodologías para el Desarrollo de Sistemas}
Horas:
...
\begin{BKL2}{TDS3}{Conceptos y Metodologías para el Desarrollo de Sistemas}
Horas:
...
\begin{BKL2}{TDS5}{Planeamiento de Aplicaciones}
Horas:
...
\begin{BKL2}{TDS7}{Gerenciamiento de Proyectos}
Horas:
...
\begin{BKL2}{TDS9}{Diseño de Sistemas de Información}
Horas:
...
\begin{BKL2}{TDS10}{Estrategias de Implementación y Pruebas de Sistemas}
Horas:
...
\begin{BKL2}{TDS11}{Operación y Mantenimiento de Sistemas}
Horas:
...
\begin{BKL2}{TDS12}{Desarrollo de Sistemas para Tipos Específicos de Sistemas de Información}
Horas:
...
\begin{BKL2}{TDS13}{Tecnologías Emergentes}
Horas:

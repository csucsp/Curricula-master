...
\OnlyPeruUCSP{\item Una sólida formación ética y proyección a la sociedad.}
\end{itemize}
...
% un análisis de mercado que incluye un aní lisis de la oferta, demanda y 
% tendencias del conocimiento.
% 
% Un aní lisis mí s detallado del mercado junto con una encuesta a empresarios
% es presentada en el Capítulo \ref{chap:cs-estudio-de-mercado}. Este estudio 
% arrojó datos interesantes con relacií²n a la percepcií²n y la necesidad 
% empresarial de este perfil profesional.
% }

% \OnlyPeruUNSA{
% En el Capítulo \ref{chap:cs-market} se presenta el perfil profesional, 
% un análisis de mercado que incluye un aní lisis de la oferta, demanda 

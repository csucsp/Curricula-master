...
\newcommand{\OnlyPeruUNI}[1]{\xspace}
\newcommand{\NotPeruUNI}[1]\{#1\xspace}

\newcommand{\OnlyPeruUTEA}[1]{\xspace}
\newcommand{\NotPeruUTEA}[1]{#1\xspace}

\newcommand{\OnlyPeruUNU}[1]{\xspace}
\newcommand{\NotPeruUNU}[1]{#1\xspace}

\newcommand{\OnlyPeruUCSP}[1]{#1\xspace}
\newcommand{\NotPeruUCSP\{}[1]{\xspace}

\newcommand{\OnlyPeruSPC}[1]{\xspace}
\newcommand{\NotPeruSPC\{}[1]{#1\xspace}

\newcommand{\OnlyPUCP}[1]{\xspace}
\newcommand{\NotPeruPUCP\{}[1]{#1\xspace}

\newcommand{\OnlyUTP}[1]{\xspace}
\newcommand{\NotPeruUTP\{}[1]{#1\xspace}

\newcommand{\OnlyPeruUNSA}[1]{\xspace}
\newcommand{\NotPeruUNSA\{}[1]{#1\xspace}
...
\newcommand{\UNOxUNOxTRESxCINCO}{Unidad de control; \textit{fetch} y ejecución de instrucciones, \textit{fetch} de operadores.}
...
\newcommand{\UNOxUNOxCUATROxTRES}{Periféricos: almacenamiento externo, organización física y \textit{drives}.}
...
\newcommand{\UNOxUNOxSEISxUNO}{Elementos lógicos y teoría de \textit{switching}; conceptos e implementación de minimización.}
...
\newcommand{\UNOxDOSxUNOxTRES}{Estrategias de resolución de problemas usando algoritmos de \textit{back- tracking}.}
...
\newcommand{\UNOxDOSxUNOxSEIS}{Estrategias de implementación (\textit{top-down}, \textit{bottom-up}; equipo vs. individual).}
...
\newcommand{\UNOxDOSxSEISxUNO}{Algoritmos de ordenamiento (\textit{shell sort}, \textit{bucket sort}, \textit{radix sort}, \textit{quick sort}), edición.}
...
\newcommand{\UNOxDOSxSIETExOCHO}{\textit{Backtracking}, \textit{parsing}, simulaciones discretas, etc.}
...
\newcommand{\UNOxTRESxSIETExUNOCINCO}{Aplicación de almacenamiento basado en \textit{heaps}.}
...
\newcommand{\UNOxTRESxSIETExDOSCERO}{Uso de autómatas de pila en el \textit{parsing} de lenguajes de programación.}
...
\newcommand{\UNOxCUATROxTRESxCINCO}{\textit{Deadlock}; causas, condiciones, prevención.}

\newcommand{\UNOxCUATROxTRESxSEIS}{Modelos y mecanismos (p.e., \textit{busy waiting}, \textit{spin locks}, algoritmo de Deker).}

\newcommand{\UNOxCUATROxTRESxSIETE}{\textit{Switching} preferente y no preferente.}

\newcommand{\UNOxCUATROxTRESxOCHO}{\textit{Schedulers} y políticas de \textit{scheduling}.}

\newcommand{\UNOxCUATROxCUATRO}{Administración de memoria.}

\newcommand{\UNOxCUATROxCUATROxUNO}{Memoria física y registros.}

\newcommand{\UNOxCUATROxCUATROxDOS}{\textit{Overlays}, \textit{swapping}, particiones.}
...
\newcommand{\UNOxCUATROxCUATROxCINCO}{\textit{Thrashing}, \textit{working sets}.}

\newcommand{\UNOxCUATROxCUATROxSEIS}{Listas libres, \textit{layout}; servidores, interrupciones; recuperación de fallos.}
...
\newcommand{\UNOxCUATROxCINCOxUNO}{\textit{Suites} de protocolos (comuniación y redes); \textit{streams} y datagramas.}

\newcommand{\UNOxCUATROxCINCOxDOS}{Internet \textit{working} y \textit{routing}; servidores y servicios.}
...
\newcommand{\UNOxCUATROxCINCOxNUEVE}{Consideraciones especiales en sistemas de tiempo real empotrados: requerimientos \textit{hard-timing}..}
...
\newcommand{\UNOxCUATROxUNODOS}{Utilidades de los sistemas operativos, herramientas, comandos y programación \textit{shell}.}

\newcommand{\UNOxCUATROxUNOTRES}{Administración y gerenciamiento de sistemas.}

\newcommand{\UNOxCUATROxUNOTRESxUNO}{\textit{Bootstrapping} del sistema/carga inicial de programa.}
...
\newcommand{\UNOxCUATROxUNOTRESxCINCO}{Optimización y \textit{tuning} del sistema.}
...
\newcommand{\UNOxCINCOxCUATROxDOS}{Redes de área local y WANs: topología, \textit{gateways}, usos (funciones y oficina).}
...
\newcommand{\UNOxCINCOxCINCO}{Redes de área amplia: técnicas de \textit{switching}, de \textit{broadcast}, \textit{routing}.}

\newcommand{\UNOxCINCOxSEIS}{Arquitecturas y protocolos de redes.}

\newcommand{\UNOxCINCOxSIETE}{\textit{Internetworking}}
...
\newcommand{\UNOxCINCOxUNOCUATROxTRES}{Redes, \textit{routing}, análisis de desempeño.}
...
\newcommand{\UNOxSEISxOCHO}{Bases de datos distribuidas, repositorios y \textit{warehouses}}
...
\newcommand{\DOSxDOSxDOS}{Control de la función de Sistemas de Información: p.e., auditoría, \textit{outsourcing}.}
...
\newcommand{\DOSxDOSxCUATRO}{Estructuras funcionales de Sistemas de Información -- internas vs. \textit{outsourcing}.}
...
\newcommand{\DOSxDOSxOCHO}{Sistemas de Información como una función de servicio: evaluación del desempeño -- externo e interno, \textit{marketing} de servicios.}
...
\newcommand{\DOSxDOSxUNODOS}{Política de Sistemas de Inf
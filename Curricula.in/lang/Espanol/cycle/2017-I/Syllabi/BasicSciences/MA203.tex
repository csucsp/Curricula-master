...
\course{MA203. Estadísticas y Probabilidades}{Obligatorio}{MA203} % Common.pm
...
\begin{unit}{Estadísticass descriptiva}{}{Sheldon,Menden}{6}{C1}
\begin{topics}
   ...
   \begin{learningoutcomes}
      ...
      \item Utilizar gráficos para comunicar las carácteristicas de los datos recopilados.
   \end{learningoutcomes}
\end{unit}

\begin{unit}{Estadísticas inferencial}{}{Sheldon,Menden}{6}{CS2}
\begin{topics}
   ...
   \begin{learningoutcomes}
      ...
      \item Analizar los datos recopilados utilizando diferentes herramientas estadistica s para responder preguntas de interés.

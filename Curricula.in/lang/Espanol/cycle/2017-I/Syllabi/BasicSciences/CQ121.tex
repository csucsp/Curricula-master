...
\course{QI0027. Química General}{Obligatorio}{QI0027} % Common.pm
...
\end{topics}
   ...
   \begin{learningoutcomes}
      \item Describir el comportamiento y carácteristicas de las ondas.
...
\begin{topics}
      ...
      \item Cambios de fase. Equilibrio líquidos-vapor. Calor de vaporización y punto de ebullición.
      \item Equilibrio líquidos-sólido. Equilibrio sólido-vapor. Diagrama de fase  del agua y del dióxido de carbono.
      \item Ejercicios y problemas.
    \end{topics}
...
\begin{topics}
      ...
      \item Disoluciones de líquidoss en líquidoss. Disoluciones de sólidos en líquidoss.

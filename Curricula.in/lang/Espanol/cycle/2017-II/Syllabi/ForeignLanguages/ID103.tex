...
\begin{unit}{It all went wrong!}{}{Soars022S, Cambridge06, MacGrew99}{0}{C25}
   ...
   \begin{learningoutcomes}
      \item Al terminar la tercera unidad, los alumnos habiendo reconocido las carácteristicas de los tiempos en pasado los utilizan adecuadamente. Utilizan prefijos y sufijos para crear y reconocer nuevas palabras. Describen tiempo en forma amplia. Utilizarán conjunciones para unir ideas tipo. 
   \end{learningoutcomes}
\end{unit}

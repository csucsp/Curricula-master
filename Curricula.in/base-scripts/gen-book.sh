...
echo "cp <OUTPUT_HTML_DOCS_DIR>/$MainFile.pdf <OUTPUT_DIR>/pdfs/<COUNTRY>-<AREA>-<INST>/<PLAN>/.;"
cp "<OUTPUT_HTML_DOCS_DIR>/$MainFile.pdf" "<OUTPUT_DIR>/pdfs/<COUNTRY>-<AREA>-<INST>/<PLAN>/.";

echo "cp <OUTPUT_HTML_DOCS_DIR>/$MainFile-P1.png <OUTPUT_DIR>/pdfs/<COUNTRY>-<AREA>-<INST>/<PLAN>/.;"
cp "<OUTPUT_HTML_DOCS_DIR>/$MainFile-P1.png" "<OUTPUT_DIR>/pdfs/<COUNTRY>-<AREA>-<INST>/<PLAN>/.";

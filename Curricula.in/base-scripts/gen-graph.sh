...
echo "Generating <OUTPUT_DOT_DIR>/$file.dot => <OUTPUT_FIGS_DIR>/$file.ps file ...";
dot -Tps <OUTPUT_DOT_DIR>/$file.dot -o <OUTPUT_FIGS_DIR>/$file.ps;
echo "gen-graph OK! (<OUTPUT_FIGS_DIR>/$file.ps)";

echo "Generating <OUTPUT_DOT_DIR>/$file.dot => <OUTPUT_FIGS_DIR>/$file.png file ...";
dot -Tsvg <OUTPUT_DOT_DIR>/$file.dot -o <OUTPUT_FIGS_DIR>/$file.svg;
echo "gen-graph OK! (<OUTPUT_FIGS_DIR>/$file.svg)";

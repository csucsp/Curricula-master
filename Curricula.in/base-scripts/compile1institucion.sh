...
set area=<AREA>
setenv CC_Area <AREA>
set CurriculaParam=<COUNTRY>-<AREA>-<INST>
#--END-FILTERS--
...
mkdir -p <OUT_LOG_DIR>;
./scripts/process-curricula.pl <COUNTRY>-<AREA>-<INST> ;
...
./scripts/update-outcome-itemizes.pl <COUNTRY>-<AREA>-<INST>
./scripts/update-page-numbers.pl <COUNTRY>-<AREA>-<INST>;
mkdir -p <OUTPUT_HTML_DIR>/figs;

if($syllabi == 1) then
    #<OUTPUT_INST_DIR>/scripts/gen-syllabi.sh all;
    ./scripts/gen-syllabi-pdf.pl <COUNTRY>-<AREA>-<INST> all;
endif

mkdir -p "<OUTPUT_DIR>/pdfs/<COUNTRY>-<AREA>-<INST>/<PLAN>";
mutool convert -o <OUTPUT_HTML_DIR>/<AREA>-<INST>-P%d.png <AREA>-<INST>.pdf 1-1;
cp <AREA>-<INST>.pdf "<OUTPUT_DIR>/pdfs/<COUNTRY>-<AREA>-<INST>/<PLAN>/<AREA>-<INST> <PLAN>.pdf";
...
if($html == 1) then
    ...
    ./scripts/gen-html-main.pl <COUNTRY>-<AREA>-<INST>;
    ...
    cp <IN_DIR>/figs/pdf.jpeg <IN_DIR>/figs/star.gif <IN_DIR>/figs/none.gif <IN_DIR>/figs/*.png <OUTPUT_HTML_FIGS_DIR>/.;
    cp <OUTPUT_FIGS_DIR>/*.png <OUTPUT_HTML_FIGS_DIR>/.;
    cp <IN_COUNTRY_DIR>/logos/<INST>.jpg <OUTPUT_HTML_FIGS_DIR>/.;

    ./scripts/update-analytic-info.pl <COUNTRY>-<AREA>-<INST>;
endif
...
./scripts/post-processing.pl <COUNTRY>-<AREA>-<INST>;
<OUTPUT_SCRIPTS_DIR>/gen-dot-maps.sh;
./scripts/update-cvs-files.pl <COUNTRY>-<AREA>-<INST>;
